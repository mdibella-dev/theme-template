...
function theme_setup() {
    ...
    add_editor_style( 'assets/build/css/frontend-style.min.css' );        // change path/name if necessary
}
...
function theme_scripts() {
    ...
    wp_enqueue_style(
        ...
        THEME_URI . 'assets/build/css/frontend-style.min.css',          // change path/name if necessary
        [],
        THEME_VERSION
    );
    ...
    wp_enqueue_script(
        ...
        THEME_URI . 'assets/build/js/frontend-script.min.js',          // change path/name if necessary
        [],
        THEME_VERSION,
        true
    );
